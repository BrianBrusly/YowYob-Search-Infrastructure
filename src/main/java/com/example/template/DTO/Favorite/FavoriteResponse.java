...
public class FavoriteResponse {
    ...
    public String toString() {
        return "FavoriteResponse(id=" + this.getId() + ", itemId=" + this.getItemId() + ", itemType=" + this.getItemType() + ", title=" + this.getTitle() + ", url=" + this.getUrl() + ", addedAt=" + String.valueOf(this.getAddedAt()) + ", notes=" + this.getNotes() + ")";
    }

    public FavoriteResponse() {
    }

    public FavoriteResponse(Long id, String itemId, String itemType, String title, String url, LocalDateTime addedAt, String notes) {
        this.id = id;
        this.itemId = itemId;
        this.itemType = itemType;
        this.title = title;
